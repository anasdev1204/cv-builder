...
import ValidatableDateInput from '@/components/cv-editor/validatable-date-input';
              ...
              <Grid gap="sm">
                <Grid.Col span={6}>
                  <ValidatableInput
                    ...
                    onChange={(val) =>
                      form.setFieldValue(`${pathPrefix}.content.${entryIndex}.title`, val)
                    }
                    isValid={isValid}
                    isError={isError}
                  />
                ...
                <Grid.Col span={6}>
                  <ValidatableInput
                    ...
                    onChange={(val) =>
                      form.setFieldValue(`${pathPrefix}.content.${entryIndex}.subtitle`, val)
                    }
                    isValid={isValid}
                    isError={isError}
                  />
                ...
                <Grid.Col span={6}>
                  <ValidatableDateInput
                    ...
                    onChange={(val) =>
                      form.setFieldValue(
                        `${pathPrefix}.content.${entryIndex}.start_date`,
                        val || null,
                      )
                    }
                    isValid={isValid}
                ...
                <Grid.Col span={6}>
                  <ValidatableDateInput
                    ...
                    onChange={(val) =>
                      form.setFieldValue(
                        `${pathPrefix}.content.${entryIndex}.end_date`,
                        val || null,
                      )
                    }
                    isValid={isValid}
                    ...
                    <Flex key={bpIndex} gap="xs" align="center">
                      <Box style={{ flex: 1 }}>
                        <ValidatableInput
                          ...
                          onChange={(val) =>
                            form.setFieldValue(
                              `${pathPrefix}.content.${entryIndex}.bullet_points.${bpIndex}`,
                              val,
                            )
                          }
                          isValid={isValid}
                      ...
                      {entry.bullet_points.length > 1 && (
                        <ActionIcon
                          color="red"
                          variant="subtle"
                          onClick={() => handleRemoveBullet(entryIndex, bpIndex)}
                        >
                          <IconTrash size={16} />
                        </ActionIcon>
                      )}
