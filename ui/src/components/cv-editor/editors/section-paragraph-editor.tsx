      ...
      <Paper p="md" withBorder mb="md">
        ...
        <Flex direction="column" gap="md">
          ...
          <ValidatableTextarea
            ...
            value={sectionKey.includes("other_sections") ? (form.values.sections[version]?.["other_sections"]?.[sectionKey.split(".")[1] as string]?.content as string) : (form.values.sections[version]?.[sectionKey as keyof typeof form.values.sections[typeof version]]?.content as string)}
