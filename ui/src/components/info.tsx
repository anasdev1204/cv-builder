...
export default function Info({
  ...
  return (
    <Box mx="auto" bd={expanded ? `1px solid ${color}.6` : undefined} bdrs="md">
      <Button
        onClick={toggle}
        fullWidth
        ...
        color={color}
      >
        {expanded ? collapseButtonLabels[1] : collapseButtonLabels[0]}
      </Button>

      <Collapse expanded={collapsible ? expanded : true}>
